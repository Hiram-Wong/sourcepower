...
function getMubans() {
  const mubanDict = {
    ...
    首图: {
      ...
      class_parse:
        ".myui-header__menu li.hidden-sm:gt(0):lt(7);a&&Text;a&&href;/(\\d+).html",
      play_parse: true,
      lazy: common_lazy,
      limit: 6,
      double: true, // 推荐内容是否双层定位
      ...
      二级: {
        title:
          ".myui-content__detail .title--span&&Text;.myui-content__detail p.data:eq(3)&&Text",
    ...
    首图2: {
      ...
      二级: {
        title:
          ".stui-content__detail .title&&Text;.stui-content__detail&&p:eq(-2)&&a&&Text",
        title1:
          ".stui-content__detail .title&&Text;.stui-content__detail&&p&&Text",
        ...
        desc1:
          ".stui-content__detail p:eq(4)&&Text;;;.stui-content__detail p:eq(1)&&Text",
        content: ".detail&&Text",
    ...
    vfed: {
      ...
      class_parse:
        ".fed-pops-navbar&&ul.fed-part-rows&&a;a&&Text;a&&href;.*/(.*?).html",
      play_parse: true,
      lazy: common_lazy,
      limit: 6,
      double: true, // 推荐内容是否双层定位

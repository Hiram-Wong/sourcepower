<template>
  <div class="t-main">
    <t-row :gutter="24" class="container">
      <t-col :xs="12" :sm="8">
      ...
      <t-col :xs="12" :sm="4" class="widget-area">
        <div class="widget">
          <t-card title="公告通知" :bordered="false" class="card-item t-card-tag">
            <p style="text-align: center">
              <span v-html="notice"></span>
            </p>
          </t-card>
          <t-card title="免责申明" :bordered="false" class="card-item t-card-tag">
            <div class="disclaimer">
              <p>1.本站仅供学习, 所有内容仅供参考。</p>
              <p>2.本站数据均由网友上传, 不保证准确性等。</p>
              <p>3.用户应自行判断适用性, 并承担相应责任。</p>
              <p>4.如有侵权内容, 请来信告知, 核实后删除。</p>
              <p>5.本站保留修改免责声明的权利, 并立即生效。</p>
              <p>6.使用本站即同意条款, 如不同意请停止使用。</p>
            </div>
          </t-card>
          <t-card title="找到我们" :bordered="false" class="card-item t-card-tag">
...
.t-main {
  margin-left: auto;
  margin-right: auto;
  padding-top: calc(var(--td-comp-size-xxxl) + var(--td-comp-paddingTB-l));
